...
#ifdef CONFIG_ARCH_ADVANTECH
#ifdef CONFIG_ADVANTECH_TWO_QSPI_SUPPORT
	{ "mx66l1g45g",  INFO(0xc2201b, 0, 64 * 1024, 1024, SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | SPI_NOR_DDR_QUAD_READ) },
#else
	{ "mx66l1g45g",  INFO(0xc2201b, 0, 64 * 1024, 2048, SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | SPI_NOR_DDR_QUAD_READ) },
#endif
#endif
