 ...
 *      should be identical.
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_portBased_set(rtk_port_t mirroring_port, rtk_portmask_t *pMirrored_rx_portmask, rtk_portmask_t *pMirrored_tx_portmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_portBased_get(rtk_port_t* pMirroring_port, rtk_portmask_t *pMirrored_rx_portmask, rtk_portmask_t *pMirrored_tx_portmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_portIso_set(rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_portIso_get(rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_vlanLeaky_set(rtk_enable_t txenable, rtk_enable_t rxenable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_vlanLeaky_get(rtk_enable_t *pTxenable, rtk_enable_t *pRxenable);
 ...
 *      The API is to set mirror VLAN leaky function forwarding packets to miror port.
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_isolationLeaky_set(rtk_enable_t txenable, rtk_enable_t rxenable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_isolationLeaky_get(rtk_enable_t *pTxenable, rtk_enable_t *pRxenable);
 ...
 *      - MIRROR_KEEP_END
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_keep_set(rtk_mirror_keep_t mode);
 ...
 *      - MIRROR_KEEP_END
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_keep_get(rtk_mirror_keep_t *pMode);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_override_set(rtk_enable_t rxMirror, rtk_enable_t txMirror, rtk_enable_t aclMirror);
 ...
 *      normal forward & mirrored packet at the same time.
 */
extern rtk_api_ret_t dal_rtl8367d_mirror_override_get(rtk_enable_t *pRxMirror, rtk_enable_t *pTxMirror, rtk_enable_t *pAclMirror);
