 ...
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_port_set(rtk_trunk_group_t trk_gid, rtk_portmask_t *pTrunk_member_portmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_port_get(rtk_trunk_group_t trk_gid, rtk_portmask_t *pTrunk_member_portmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_distributionAlgorithm_set(rtk_trunk_group_t trk_gid, rtk_uint32 algo_bitmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_distributionAlgorithm_get(rtk_trunk_group_t trk_gid, rtk_uint32 *pAlgo_bitmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_trafficSeparate_set(rtk_trunk_group_t trk_gid, rtk_trunk_separateType_t separateType);
 ...
 *      SEPARATE_FLOOD: trunk MSB link up port is dedicated to TX flooding (L2 lookup miss) traffic
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_trafficSeparate_get(rtk_trunk_group_t trk_gid, rtk_trunk_separateType_t *pSeparateType);
 ...
 *      - TRUNK_MODE_DUMB
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_mode_set(rtk_trunk_mode_t mode);
 ...
 *      - TRUNK_MODE_DUMB
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_mode_get(rtk_trunk_mode_t *pMode);
 ...
 *      None.
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_trafficPause_set(rtk_trunk_group_t trk_gid, rtk_enable_t enable);
 ...
 *      None.
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_trafficPause_get(rtk_trunk_group_t trk_gid, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_hashMappingTable_set(rtk_trunk_group_t trk_gid, rtk_trunk_hashVal2Port_t *pHash2Port_array);
 ...
 *      Trunk group 2 uses a independent table.
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_hashMappingTable_get(rtk_trunk_group_t trk_gid, rtk_trunk_hashVal2Port_t *pHash2Port_array);
 ...
 *      None.
 */
extern rtk_api_ret_t dal_rtl8367d_trunk_portQueueEmpty_get(rtk_portmask_t *pEmpty_portmask);
