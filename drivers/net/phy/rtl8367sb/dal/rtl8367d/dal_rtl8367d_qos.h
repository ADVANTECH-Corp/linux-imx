 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_init(rtk_queue_num_t queueNum);
 ...
 *      - RTL8367D_PRIDEC_1AD
 */
extern rtk_api_ret_t dal_rtl8367d_qos_priSel_set(rtk_qos_priDecTbl_t index, rtk_priority_select_t *pPriDec);
 ...
 *      - RTL8367D_PRIDEC_1AD,
 */
extern rtk_api_ret_t dal_rtl8367d_qos_priSel_get(rtk_qos_priDecTbl_t index, rtk_priority_select_t *pPriDec);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_1pPriRemap_set(rtk_pri_t dot1p_pri, rtk_pri_t int_pri);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_1pPriRemap_get(rtk_pri_t dot1p_pri, rtk_pri_t *pInt_pri);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_1pRemarkSrcSel_set(rtk_qos_1pRmkSrc_t type);
 ...
 *      None
 */
extern rtk_api_ret_t dal_rtl8367d_qos_1pRemarkSrcSel_get(rtk_qos_1pRmkSrc_t *pType);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_dscpPriRemap_set(rtk_dscp_t dscp, rtk_pri_t int_pri);
 ...
 *      DSCP are carefully chosen then backward compatibility can be achieved.
 */
extern rtk_api_ret_t dal_rtl8367d_qos_dscpPriRemap_get(rtk_dscp_t dscp, rtk_pri_t *pInt_pri);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_portPri_set(rtk_port_t port, rtk_pri_t int_pri) ;
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_portPri_get(rtk_port_t port, rtk_pri_t *pInt_pri) ;
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_queueNum_set(rtk_port_t port, rtk_queue_num_t queue_num);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_queueNum_get(rtk_port_t port, rtk_queue_num_t *pQueue_num);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_priMap_set(rtk_queue_num_t queue_num, rtk_qos_pri2queue_t *pPri2qid);
 ...
 *      The queue number is from 1 to 8.
 */
extern rtk_api_ret_t dal_rtl8367d_qos_priMap_get(rtk_queue_num_t queue_num, rtk_qos_pri2queue_t *pPri2qid);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_schedulingQueue_set(rtk_port_t port, rtk_qos_queue_weights_t *pQweights);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_schedulingQueue_get(rtk_port_t port, rtk_qos_queue_weights_t *pQweights);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367d_qos_1pRemarkEnable_set(rtk_port_t port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367d_qos_1pRemarkEnable_get(rtk_port_t port, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_1pRemark_set(rtk_pri_t int_pri, rtk_pri_t dot1p_pri);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_1pRemark_get(rtk_pri_t int_pri, rtk_pri_t *pDot1p_pri);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367d_qos_dscpRemarkEnable_set(rtk_port_t port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367d_qos_dscpRemarkEnable_get(rtk_port_t port, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_dscpRemark_set(rtk_pri_t int_pri, rtk_dscp_t dscp);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_dscpRemark_get(rtk_pri_t int_pri, rtk_dscp_t *pDscp);
 ...
 *      priority to TX DSCP value.
 */
extern rtk_api_ret_t dal_rtl8367d_qos_dscpRemarkSrcSel_set(rtk_qos_dscpRmkSrc_t type);
 ...
 *      None
 */
extern rtk_api_ret_t dal_rtl8367d_qos_dscpRemarkSrcSel_get(rtk_qos_dscpRmkSrc_t *pType);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_schedulingType_set(rtk_qos_scheduling_type_t type);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_qos_schedulingType_get(rtk_qos_scheduling_type_t *pType);
 ...
 *      The API can set priority of port assignments for queue usage and packet scheduling.
 */
 extern rtk_api_ret_t dal_rtl8367d_qos_portPriSelIndex_set(rtk_port_t port, rtk_qos_priDecTbl_t index);
 ...
 *      The API can get priority of port assignments for queue usage and packet scheduling.
 */
 extern rtk_api_ret_t dal_rtl8367d_qos_portPriSelIndex_get(rtk_port_t port, rtk_qos_priDecTbl_t *pIndex);
