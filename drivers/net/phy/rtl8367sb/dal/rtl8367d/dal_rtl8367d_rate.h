 ...
 */
extern rtk_api_ret_t dal_rtl8367d_rate_shareMeter_set(rtk_meter_id_t index, rtk_meter_type_t type, rtk_rate_t rate, rtk_enable_t ifg_include);
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8367d_rate_shareMeter_get(rtk_meter_id_t index, rtk_meter_type_t *pType, rtk_rate_t *pRate, rtk_enable_t *pIfg_include);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_rate_shareMeterBucket_set(rtk_meter_id_t index, rtk_uint32 bucket_size);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_rate_shareMeterBucket_get(rtk_meter_id_t index, rtk_uint32 *pBucket_size);
