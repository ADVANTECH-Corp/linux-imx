...
typedef struct hal_csirxinfo {
	...
	// DWORD-0
	UINT32 data_length : 13; // Includes BF_INFO, LTF Data, and CSI Data.
				 // Length in dwords
	UINT32 ltf : 1;
	UINT32 csi : 1;
	UINT32 tbd : 1;
...
typedef struct hal_wls_packet_params {
	...
	UINT32 isFtmInit : 1; // indicate if this is FTM exchange initiator or
			      // responder
	UINT32 ftmSignalBW : 3; // Channel bandwidth 0: 20 MHz, 1: 40 MHz, 2: 80
				// MHz, 3: 160 Mhz, 4-7 reserved
	UINT32 ftmPacketType : 3; // Format of FTM exchange 0: legacy, 1:HT,
				  // 3:VHT, 4:HE
	UINT32 freqBandFlag : 1; // Declare channel frequency band flag, 0: 2.4
				 // GHz & 5 GHz; 1 : 6 GHz
