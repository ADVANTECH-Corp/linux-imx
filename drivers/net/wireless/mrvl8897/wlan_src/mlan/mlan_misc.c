			 ...
			 IN pmlan_ioctl_req pioctl_req)
{
	...
	if (pioctl_req->action == MLAN_ACT_GET) {
		...
		debug_info->txbd_rdptr = pmadapter->txbd_rdptr;
		debug_info->txbd_wrptr = pmadapter->txbd_wrptr;
		debug_info->rxbd_rdptr = pmadapter->rxbd_rdptr;
		debug_info->rxbd_wrptr = pmadapter->rxbd_wrptr;
		debug_info->eventbd_rdptr = pmadapter->evtbd_rdptr;
		debug_info->eventbd_wrptr = pmadapter->evtbd_wrptr;
