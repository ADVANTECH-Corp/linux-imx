 ...
 *
 *  @param pmoal Pointer to the MOAL context
 *  @param status   The status code for mlan_wifi6_init_fw request
 ...
 *
 *  @param pmoal Pointer to the MOAL context
 *  @param pioctl_req	pointer to structure mlan_wifi6_ioctl_req
 *  @param status   The status code for mlan_wifi6_ioctl request
 *
 *  @return         MLAN_STATUS_SUCCESS
 */
mlan_status moal_ioctl_complete(t_void *pmoal, pmlan_wifi6_ioctl_req pioctl_req,
				mlan_status status)
{
	moal_handle *handle = (moal_handle *)pmoal;
 ...
 *  @param status   The status code for mlan_wifi6_send_packet request
 *
 *  @return         MLAN_STATUS_SUCCESS
 */
