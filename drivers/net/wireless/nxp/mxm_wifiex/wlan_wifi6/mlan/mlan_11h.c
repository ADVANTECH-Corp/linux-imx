 ...
 *
 *  @param pmadapter        Pointer to mlan_adapter
 *  @param pioctl_req       Pointer to completed mlan_wifi6_ioctl_req (allocated
 * inside)
...
wlan_11h_prepare_custom_ie_chansw(mlan_adapter *pmadapter,
				  mlan_wifi6_ioctl_req **ppioctl_req,
				  t_bool is_adding_ie)
{
	...
	/* allocate buffer for mlan_wifi6_ioctl_req and mlan_ds_misc_cfg */
	/* FYI - will be freed as part of cmd_response handler */
	ret = pmadapter->callbacks.moal_malloc(
		pmadapter->pmoal_handle,
		sizeof(mlan_wifi6_ioctl_req) + sizeof(mlan_ds_misc_cfg), MLAN_MEM_DEF,
		(t_u8 **)&pioctl_req);
	...
	pds_misc_cfg = (mlan_ds_misc_cfg *)((t_u8 *)pioctl_req +
					    sizeof(mlan_wifi6_ioctl_req));

	/* prepare mlan_wifi6_ioctl_req */
	memset(pmadapter, pioctl_req, 0x00, sizeof(mlan_wifi6_ioctl_req));
	pioctl_req->req_id = mlan_wifi6_ioctl_MISC_CFG;
...
t_s32 wlan_11h_issue_radar_detect(mlan_private *priv,
				  pmlan_wifi6_ioctl_req pioctl_req, t_u8 channel,
 ...
 *
 *  @param pmadapter    Pointer to mlan_adapter
 *  @param pioctl_req   Pointer to mlan_wifi6_ioctl_req
 *
 *  @return MLAN_STATUS_SUCCESS or MLAN_STATUS_FAILURE
 */
