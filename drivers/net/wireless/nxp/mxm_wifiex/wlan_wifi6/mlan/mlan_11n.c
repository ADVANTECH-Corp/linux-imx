...
void wlan_11n_send_delba_to_peer(mlan_private *priv, t_u8 *ra)
{
	...
	wlan_release_ralist_lock(priv);
	/* Signal MOAL to trigger mlan_wifi6_main_process */
...
static mlan_status wlan_send_delba_to_entry_in_txbastream_tbl(
	pmlan_private priv, pmlan_wifi6_ioctl_req pioctl_req, t_u8 tid,
 ...
 *  @return             MLAN_STATUS_PENDING --success, otherwise fail
 */
int wlan_send_delba(mlan_private *priv, pmlan_wifi6_ioctl_req pioctl_req, int tid,
