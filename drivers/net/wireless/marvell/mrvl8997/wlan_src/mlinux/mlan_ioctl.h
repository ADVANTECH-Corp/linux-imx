...
enum _mlan_ioctl_req_id {
	...
	MLAN_OID_GET_DPD_LOG = 0x0005000C,
	...
	MLAN_OID_MISC_DIAG_LOOPBACK = 0x00200005,
	...
	MLAN_OID_MISC_DPDLOG_ENABLE = 0x00200069,
...
/* mlan_ds_get_dpdlog */
typedef MLAN_PACK_START struct _mlan_ds_get_dpdlog {
	dpdlog_t dpdlog;
} MLAN_PACK_END mlan_ds_get_dpdlog;
...
/** Event body : evt_diag_loopback */
typedef MLAN_PACK_START struct _evt_diag_loopback {
...
} MLAN_PACK_END evt_diag_loopback;
...
typedef struct _mlan_ds_misc_diag_loopback {
	...
	evt_diag_loopback loopback_info;
...
typedef struct _mlan_ds_misc_cfg {
	...
	/** Region code for MLAN_OID_MISC_REGION */
		t_u32 region_code;
	/** Loopback command for MLAN_OID_DIAG_LOOPBACK */
		mlan_ds_misc_diag_loopback diag_cmd;
#if defined(SDIO_MULTI_PORT_TX_AGGR) || defined(SDIO_MULTI_PORT_RX_AGGR)
