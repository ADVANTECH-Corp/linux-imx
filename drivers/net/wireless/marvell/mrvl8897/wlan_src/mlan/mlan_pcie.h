...
#define PCIE_RD_DATA_PTR_Q0_Q1          0xC08C	/* 0x8000C08C */
/* PCIE read data pointer for queue 2 and 3 */
#define PCIE_RD_DATA_PTR_Q2_Q3          0xC090	/* 0x8000C090 */
/* PCIE write data pointer for queue 0 and 1 */
#define PCIE_WR_DATA_PTR_Q0_Q1          0xC05C	/* 0x8000C05C */
/* PCIE write data pointer for queue 2 and 3 */
#define PCIE_WR_DATA_PTR_Q2_Q3          0xC060	/* 0x8000C060 */
...
#define TXRX_RW_PTR_MASK                     0x000003FF
/** Tx/Rx Read/Write pointer's wrap mask */
#define TXRX_RW_PTR_WRAP_MASK                0x000007FF
/** Tx/Rx Read/Write pointer's rollover indicate bit */
#define TXRX_RW_PTR_ROLLOVER_IND             MBIT(10)
