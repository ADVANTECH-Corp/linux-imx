				       ...
				       t_u32 respbuflen, t_u8 wait_option)
{
	...
	req = woal_alloc_mlan_wifi6_ioctl_req(sizeof(mlan_ds_11ax_cmd_cfg));
	if (req == NULL) {
		ret = -ENOMEM;
		goto done;
	}

	req->req_id = mlan_wifi6_ioctl_11AX_CFG;
	req->action = MLAN_ACT_SET;
				   ...
				   t_u32 respbuflen)
{
	...
	req = woal_alloc_mlan_wifi6_ioctl_req(sizeof(mlan_ds_11ac_cfg));
	if (req == NULL) {
		ret = -ENOMEM;
		goto done;
	}
	...
	req->req_id = mlan_wifi6_ioctl_11AC_CFG;
			       ...
			       t_u32 respbuflen)
{
	...
	ioctl_req = woal_alloc_mlan_wifi6_ioctl_req(sizeof(mlan_ds_bss));
	if (ioctl_req == NULL) {
		ret = -ENOMEM;
		goto done;
	}
	...
	ioctl_req->req_id = mlan_wifi6_ioctl_BSS;
	ioctl_req->action = MLAN_ACT_SET;
				  ...
				  t_u32 respbuflen)
{
	...
	/* Allocate an IOCTL request buffer */
	ioctl_req = (mlan_wifi6_ioctl_req *)woal_alloc_mlan_wifi6_ioctl_req(
	...
	ioctl_req->req_id = mlan_wifi6_ioctl_GET_INFO;
	ioctl_req->action = MLAN_ACT_GET;
				   ...
				   t_u32 respbuflen)
{
	...
	req = woal_alloc_mlan_wifi6_ioctl_req(sizeof(mlan_ds_wps_cfg));
	if (req == NULL) {
		ret = -ENOMEM;
		goto done;
	}
	...
	req->req_id = mlan_wifi6_ioctl_WPS_CFG;
	req->action = MLAN_ACT_SET;
				 ...
				 t_u32 respbuflen)
{
	...
	ioctl_req->req_id = mlan_wifi6_ioctl_PM_CFG;
			     ...
			     t_u32 respbuflen)
{
	...
	req = woal_alloc_mlan_wifi6_ioctl_req(sizeof(mlan_ds_reg_mem));
	if (req == NULL) {
		ret = -ENOMEM;
		goto done;
	}
	...
	req->req_id = mlan_wifi6_ioctl_REG_MEM;
			     ...
			     t_u32 respbuflen)
{
	...
	req = woal_alloc_mlan_wifi6_ioctl_req(sizeof(mlan_ds_11d_cfg));
	if (req == NULL) {
		ret = ENOMEM;
		goto done;
	}
	...
	req->req_id = mlan_wifi6_ioctl_11D_CFG;
				 ...
				 t_u32 respbuflen)
{
	...
	req = woal_alloc_mlan_wifi6_ioctl_req(sizeof(mlan_ds_11ax_cfg));
	if (req == NULL) {
		ret = -ENOMEM;
		goto done;
	}
			       ...
			       t_u32 respbuflen)
{
	...
	req = woal_alloc_mlan_wifi6_ioctl_req(sizeof(mlan_ds_twtcfg));
	if (req == NULL) {
				 ...
				 t_u32 respbuflen)
{
	...
	if (IS_CARD9098(priv->phandle->card_type) ||
		...
		if (user_data_len >= 2) {
			...
			req = woal_alloc_mlan_wifi6_ioctl_req(
