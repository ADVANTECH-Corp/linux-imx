...
typedef rtk_uint32  rtk_port_phy_data_t;     /* phy data  */
...
typedef enum rtk_port_phy_type_e
{
...
typedef struct rtk_port_extPhyAutoPollingCfg_e
{
    rtk_enable_t state;
    rtk_port_phy_type_t extPhyType;
    rtk_uint32 extPhyID;
} rtk_port_extPhyAutoPollingCfg_t;
...
typedef enum rtk_port_sdsPolarity_e
{
    SDS_POLARITY_NORMAL = 0,
    SDS_POLARITY_REVERSE,
    SDS_POLARITY_END
} rtk_port_sdsPolarity_t;
 ...
 */
extern rtk_api_ret_t rtk_port_serdesReg_set(rtk_uint32 sdsID, rtk_uint32 page, rtk_uint32 reg, rtk_uint32 regData);
 ...
 */
extern rtk_api_ret_t rtk_port_serdesReg_get(rtk_uint32 sdsID, rtk_uint32 page, rtk_uint32 reg, rtk_uint32 *pData);
 ...
 */
extern rtk_api_ret_t rtk_port_serdesPolarity_set(rtk_uint32 sdsID, rtk_port_sdsPolarity_t inputPolarity, rtk_port_sdsPolarity_t outputPolarity);
 ...
 *      This API can set serdes polarity of the specific sdsID.
 */
extern rtk_api_ret_t rtk_port_serdesPolarity_get(rtk_uint32 sdsID, rtk_port_sdsPolarity_t *pInputPolarity, rtk_port_sdsPolarity_t *pOutputPolarity);
 ...
 */
extern rtk_api_ret_t rtk_port_extPhyAutoPollingCfg_set(rtk_port_t port, rtk_port_extPhyAutoPollingCfg_t *pCfg);
 ...
 *      This API can set External PHY auto polling function.
 */
extern rtk_api_ret_t rtk_port_extPhyAutoPollingCfg_get(rtk_port_t port, rtk_port_extPhyAutoPollingCfg_t *pCfg);
 ...
 */
extern rtk_api_ret_t rtk_port_extPhySmiState_set(rtk_enable_t state);
 ...
 *      This API can set the state of SMI master.
 */
extern rtk_api_ret_t rtk_port_extPhySmiState_get(rtk_enable_t *pState);
 ...
 */
extern rtk_api_ret_t rtk_port_extPhyReg_set(rtk_uint32 phyID, rtk_port_phy_page_t page, rtk_port_phy_reg_t reg, rtk_port_phy_data_t data);
 ...
 *      This API can set register of external MDC/MDIO slave device.
 */
extern rtk_api_ret_t rtk_port_extPhyReg_get(rtk_uint32 phyID, rtk_port_phy_page_t page, rtk_port_phy_reg_t reg, rtk_port_phy_data_t *pData);
 ...
 */
extern rtk_api_ret_t rtk_port_extC45PhyReg_set(rtk_uint32 phyID, rtk_uint32 mmd, rtk_port_phy_reg_t reg, rtk_port_phy_data_t data);
 ...
 *      This API can set register of external C45 MDC/MDIO slave device.
 */
extern rtk_api_ret_t rtk_port_extC45PhyReg_get(rtk_uint32 phyID, rtk_uint32 mmd, rtk_port_phy_reg_t reg, rtk_port_phy_data_t *pData);
