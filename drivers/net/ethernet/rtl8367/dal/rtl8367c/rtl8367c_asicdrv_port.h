...
extern ret_t rtl8367c_setSmiMasterIfEn(void);
extern ret_t rtl8367c_setPollingExtPhyType(rtk_uint32 extPhyId,rtk_uint32 type);
extern ret_t rtl8367c_setSmiExtPhyAddr(rtk_uint32 extPhyId,rtk_uint32 addr);
extern ret_t rtl8367c_setSdsMode(rtk_uint32 sdsId,rtk_uint32 mode);

extern ret_t rtl8367c_cfgHsgWorkAroundfor70c(rtk_uint32 port);
extern ret_t rtl8367c_ext8211_auto(void);
