 ...
 *      - LEAKY_LLDP.
 */
extern rtk_api_ret_t dal_rtl8367d_leaky_vlan_set(rtk_leaky_type_t type, rtk_enable_t enable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtk_api_ret_t dal_rtl8367d_leaky_vlan_get(rtk_leaky_type_t type, rtk_enable_t *pEnable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtk_api_ret_t dal_rtl8367d_leaky_portIsolation_set(rtk_leaky_type_t type, rtk_enable_t enable);
 ...
 *      - LEAKY_LLDP.
 */
extern rtk_api_ret_t dal_rtl8367d_leaky_portIsolation_get(rtk_leaky_type_t type, rtk_enable_t *pEnable);
