...
#define RTL8367D_MAX_SDS_PAGE           7
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_port_rtctEnable_set(rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_port_rtctDisable_set(rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_port_rtctResult_get(rtk_port_t port, rtk_rtctResult_t *pRtctResult);
 ...
 *      None.
 */
extern rtk_api_ret_t dal_rtl8367d_port_maxPacketLength_set(rtk_port_t port, rtk_uint32 length);
 ...
 *      None.
 */
extern rtk_api_ret_t dal_rtl8367d_port_maxPacketLength_get(rtk_port_t port, rtk_uint32 *pLength);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t dal_rtl8367d_port_phyLinkDownPowerSaving_set(rtk_port_t port, rtk_enable_t state);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_port_phyLinkDownPowerSaving_get(rtk_port_t port, rtk_enable_t *pState);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_port_serdesReg_set(rtk_uint32 sdsID, rtk_uint32 page, rtk_uint32 reg, rtk_uint32 regData);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_port_serdesReg_get(rtk_uint32 sdsID, rtk_uint32 page, rtk_uint32 reg, rtk_uint32 *pData);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_port_serdesPolarity_set(rtk_uint32 sdsID, rtk_port_sdsPolarity_t inputPolarity, rtk_port_sdsPolarity_t outputPolarity);
 ...
 *      This API can set serdes polarity of the specific sdsID.
 */
extern rtk_api_ret_t dal_rtl8367d_port_serdesPolarity_get(rtk_uint32 sdsID, rtk_port_sdsPolarity_t *pInputPolarity, rtk_port_sdsPolarity_t *pOutputPolarity);
